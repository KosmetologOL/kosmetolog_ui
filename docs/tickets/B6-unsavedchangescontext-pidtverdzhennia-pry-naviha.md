...
- [ ] З незбереженими змінами клік «Пацієнти», «Довідники» або «Вийти» показує підтвердження «Є незбережені зміни. Закрити без збереження?»; «Скасувати» лишає на сторінці листа з незмінним станом форми, «OK» виконує перехід/вихід.
- [ ] З чистою формою (щойно збережено або нічого не змінено) підтвердження не зʼявляється.
- [ ] Після розмонтування форми (перехід підтверджено) прапорець скидається — на інших сторінках навігація не питає підтвердження.
- [ ] «Назад» із листа, відкритого прямим посиланням у новій вкладці, веде на /patients, а не за межі застосунку.
