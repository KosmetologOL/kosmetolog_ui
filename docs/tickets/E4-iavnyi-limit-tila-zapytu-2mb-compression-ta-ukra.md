...
- [x] POST /reports з валідним тілом ~300–500kb (довгі кириличні текстові поля) повертає 201, а не 413.
- [x] Тіло понад 2mb → 413 з JSON {"message":"Занадто великий обсяг даних"} (українською).
- [x] Відповіді API містять Content-Encoding: gzip при запиті з Accept-Encoding: gzip.
