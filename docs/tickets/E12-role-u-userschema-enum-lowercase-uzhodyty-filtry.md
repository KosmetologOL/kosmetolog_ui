...
- [x] Реєстрація з role у будь-якому регістрі ("USER", "Doctor") зберігає в БД значення в нижньому регістрі.
- [x] Користувач, створений через підтвердження заявки, має role в нижньому регістрі.
- [x] У БД немає користувачів з role поза ["admin", "doctor", "user"] (або наявні розбіжності зафіксовані і погоджені з власником).
- [x] Адмінка лікарів показує і дозволяє видалити кожного користувача з роллю doctor.
