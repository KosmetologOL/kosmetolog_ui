...
- [ ] Запит до /auth/login із заголовком X-Forwarded-For не повертає 500 і не пише помилку валідації express-rate-limit у консоль
- [ ] Ліміт рахується за клієнтським IP: різні значення X-Forwarded-For мають незалежні лічильники
- [ ] GET /auth/refresh обмежений 60 запитами за 15 хв з одного IP; понад ліміт — 429 з українським повідомленням
- [ ] Наявні ліміти login (10/15 хв) і register (10/год) працюють як раніше
