...
- [ ] Контраст кольору ink-soft на фонах paper (#f4f3ee) і surface-2 (#eeede5) ≥ 4.5:1 (перевірено контраст-калькулятором).
- [ ] Клік по лейблу NoteField фокусує його textarea; усі textarea форми листа мають accessible name у DevTools → Accessibility.
- [ ] Заголовки секцій форми листа — елементи h2; у форми зʼявляється ієрархія заголовків h1 → h2.
- [ ] У табах довідників: стрілки вліво/вправо перемикають таби по колу, Tab-ом фокус не ходить по всіх пілюлях (roving tabindex), контент має role="tabpanel" з aria-labelledby на активний таб.
- [ ] Активна сторінка пагінації реєстру має aria-current="page".
- [ ] Візуальний вигляд шапки, чипів, stage-card і секцій не зламався (лише трохи темніший другорядний текст).
