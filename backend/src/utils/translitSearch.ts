...
/*
  Пошук латиницею по кириличних назвах: «krem» знаходить «Крем», «shampun» —
  «Шампунь», «skrininh» — «Скринінг».

  Замість перекладу запиту в одну транслітерацію (стандартів кілька, і жоден
  не збігається з тим, як лікар друкує на слух) кожна літера запиту стає
  класом «латинська + її кириличні відповідники», а діграфи (sh, ch, ts…) —
  альтернативою «кирилична літера | дві окремі літери». Тому патерн однаково
  знаходить і кирилицю, і латинські назви у базі (BR Eau Micellaire), а
  кириличний ввід працює точно як раніше.
*/
